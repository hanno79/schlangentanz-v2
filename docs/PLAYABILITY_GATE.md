...
- [x] Commit/Push/Deploy/Smoke: Feature- und Release-Dokumentationsstand werden nach `origin/main` gepusht und per Vercel Production auf die stabile Alias `https://schlangentanz-v2.vercel.app` bereitgestellt. Der finale Alias-Smoke muss `/`, `/game`, Kernregionen, M1as/M1aw/M1ax/M1ay/M1bc/M1bd/M1bf/M1ba/M1bb-Verträge, den M1bf-Nachziehstapel und leere Console-/Page-Errors bestätigen.

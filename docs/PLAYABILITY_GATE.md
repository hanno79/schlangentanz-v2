...
- [ ] Commit/Push/Deploy/Smoke: lokal verifiziert; finaler Production-Deploy und `/`/`/game`-Smoke auf `https://schlangentanz-v2.vercel.app` folgen mit diesem Release-Commit.

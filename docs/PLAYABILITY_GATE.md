...
- [ ] Commit/Push/Deploy/Smoke: Feature-Commit `38ecc32 — M1ba: Startkreis-Vorschau als Brettobjekt zeigen` ist erstellt. Finaler Dokumentations-HEAD wird nach Push per Vercel Production auf die stabile Alias `https://schlangentanz-v2.vercel.app` deployt und erneut mit Production-Smoke geprüft.

...
Wird mit dem M5d-Commit auf `origin/main` gebracht und anschließend auf `https://schlangentanz-v2.vercel.app` bereitgestellt. Finaler Smoke prüft `/` und `/game`, den board-nahen Zugkompass, eine echte Phasenweiterführung bis zum KI-Zug und zurück zum Menschen sowie Console-/Page-Error-Freiheit.

...
describe('M1by Waldtanz-Spielbrettweite', () => {
  ...
  it('legt den route-sicheren CSS- und Smoke-Vertrag fuer eine breite Waldstein-Spielmatte ab', () => {
    ...
    expect(zugleiste).toMatch(/grid-template-columns:\s*repeat\(4,\s*minmax\(min\(100%,\s*11rem\),\s*1fr\)\)/)
    expect(zugleiste).toMatch(/max-height:\s*clamp\(6\.5rem,\s*18vh,\s*9rem\)/)

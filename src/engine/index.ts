...
export { berechneFarbgruppenPunkte, berechneSpielerFarbgruppenPunkte, berechneSpielerAufgabenPunkte, berechneSpielerGesamtPunkte, berechneSpielGesamtwertung, berechneSpielzustandGesamtwertung, berechneGewinner, ermittleFarbenFuerFarbvielfalt, ermittleRegenbogenWildfarben } from './scoring';

...
describe('M1bn Waldtanz-Spielhilfe in der Zugleiste', () => {
  ...
  it('legt den kompakten Google-Stitch-CSS-Vertrag fuer die board-nahe Spielhilfe ab', () => {
    ...
    expect(cssBlock('.spielbereich--game-route [class~="waldtanz-spielhilfe"]')).toMatch(/max-height:\s*clamp\(12rem, 30vh, 18rem\)/)
    expect(cssBlock('.spielbereich--game-route [class~="waldtanz-spielhilfe"]')).toMatch(/overflow:\s*auto/)

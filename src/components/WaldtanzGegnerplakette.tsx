...
# AENDERUNG 05.07.2026: H3 — der dekorative Gegnerhand-Kartenfaecher ("Peek") wurde
entfernt. Er leitete verdeckte Gegner-Handinformation ab (Anzahl der Farbkarten in
den ersten Handkarten) und verstiess damit gegen R1.3 (Handkarten anderer Spieler
duerfen nicht sichtbar sein).
*/
